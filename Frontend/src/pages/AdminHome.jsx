  ...
  if (!isAuthenticated || userRole !== "admin") {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
        <div className="p-8 rounded-3xl bg-slate-800 border border-slate-700 text-center max-w-sm space-y-4">
          <div className="w-12 h-12 rounded-2xl bg-red-500/20 text-red-400 mx-auto flex items-center justify-center">
            <ShieldAlert size={24} />
          </div>
          <h2 className="text-xl font-bold text-white">Access Denied</h2>
          <p className="text-xs text-slate-400">This area is restricted to authorized municipal officers.</p>
          <Link to="/login">
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col justify-between">
      ...
      <div className="pt-10 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            ...
            <Link to="/solves-complaints">
              <button className="flex items-center gap-2 px-7 py-3.5 rounded-2xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 font-semibold text-sm transition-all cursor-pointer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Resolved KPI */}
          <div className="p-8 rounded-3xl bg-slate-900/90 border border-slate-800 hover:border-emerald-500/40 shadow-xl transition-all space-y-4 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-4xl font-black text-white tracking-tight">{counts.Resolved || 0}</span>
            </div>
            <div>
              <h3 className="font-bold text-xl text-white">Resolved Incidents</h3>
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Total road hazards successfully repaired with verified after-fix photos uploaded.
              </p>
            </div>
            <Link to="/solves-complaints" className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-400 hover:text-emerald-300 pt-2">
          ...
          {/* Rejected KPI */}
          <div className="p-8 rounded-3xl bg-slate-900/90 border border-slate-800 hover:border-red-500/40 shadow-xl transition-all space-y-4 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-4xl font-black text-white tracking-tight">{counts.Rejected || 0}</span>
            </div>
            <div>
              <h3 className="font-bold text-xl text-white">Rejected / Spam Submissions</h3>
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Reports disqualified due to duplicate submissions, invalid photos, or off-scope issues.
              </p>
            </div>
            <Link to="/complaints" className="inline-flex items-center gap-1 text-xs font-semibold text-red-400 hover:text-red-300 pt-2">
